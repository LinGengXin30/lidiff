...
@click.command()
@click.option('--path', '-p', type=str, default="/media/fang/extra/dataset/data_odometry/dataset/sequences", help='path to the scan sequence')
@click.option('--voxel_size', '-v', type=float, default=0.5, help='voxel size')
